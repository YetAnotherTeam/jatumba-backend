# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-17 10:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, verbose_name='Название')),
                ('file', audiofield.fields.AudioField(help_text='Allowed type - .mp3, .wav, .ogg', upload_to=api.models.organization.sounds_path, verbose_name='Audio-файл')),
